// AUTOGENERATED: 7b3ad55ac9d11e4291c6a9e6d2ed2d18
...
public interface GroupManagementService {
    ...
    /**
     * FIXME: Does this method do anything sensible? (KK, 09.01.2012)
     * 
     * To add a Member to a group, you actually need to do something like the following, instead of calling this method:
     * <pre>
     *     AVTransportService avTransportService = memberDevice.getAVTransportService()
     *     AVTransportURI uri = AVTransportURI.playFromDevice(groupCoordinatorDevice.getDeviceId());
     *     avTransportService.setAVTransportURI(uri, null, new VoidCallback()).waitForSuccess();
     * </pre>
     * 
     * 
     * @param memberID
