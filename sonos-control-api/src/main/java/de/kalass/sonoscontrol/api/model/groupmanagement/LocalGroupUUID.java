// AUTOGENERATED: cbc14530a9acf1ccfee8432b867889d6
...
public final class LocalGroupUUID implements Serializable {
    ...
    public static final Function<LocalGroupUUID, String> GET_VALUE = new Function<LocalGroupUUID, String>() {
        @Override
        public String apply(LocalGroupUUID input) {
