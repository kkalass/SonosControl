// AUTOGENERATED: 291394241f6e2e1e4b9f14dba1d7e37f
...
public final class EQType implements Serializable {
    ...
    public static final Function<EQType, String> GET_VALUE = new Function<EQType, String>() {
        @Override
        public String apply(EQType input) {
