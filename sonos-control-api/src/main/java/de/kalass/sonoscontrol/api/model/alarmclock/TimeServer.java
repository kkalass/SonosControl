// AUTOGENERATED: 188a025b4a0013fe295619a0aa8ab4b8
...
public final class TimeServer implements Serializable {
    ...
    public static final Function<TimeServer, String> GET_VALUE = new Function<TimeServer, String>() {
        @Override
        public String apply(TimeServer input) {
