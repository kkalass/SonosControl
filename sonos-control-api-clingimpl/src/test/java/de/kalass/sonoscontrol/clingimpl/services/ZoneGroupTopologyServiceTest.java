// AUTOGENERATED: ef2022c76fd348d01648b6d36a741878
...
public class ZoneGroupTopologyServiceTest extends AbstractSonosServiceTest<ZoneGroupTopologyService> {
  ...
  @Override
    ...
    /*
    @Test
    public void checkForUpdateTest() throws Exception{
        final UpdateItem value = getService().checkForUpdate(updateType, cachedOnly, version, new AsyncValue<UpdateItem>()).get();
        Assert.assertNotNull(value);
        System.out.println("Got checkForUpdate: " + value);
    }
    */

    /*
    @Test
    public void beginSoftwareUpdateTest() throws Exception{
        getService().beginSoftwareUpdate(updateURL, flags, new VoidCallback()).waitForSuccess();
        System.out.println("Finished beginSoftwareUpdate");
    }
    */

    /*
    @Test
    public void reportUnresponsiveDeviceTest() throws Exception{
        getService().reportUnresponsiveDevice(deviceUUID, desiredAction, new VoidCallback()).waitForSuccess();
        System.out.println("Finished reportUnresponsiveDevice");
    }
    */
    ...
    public void reportAlarmStartedRunningTest() throws Exception{
        getService().reportAlarmStartedRunning(new VoidCallback()).waitForSuccess();
    ...
    */
    ...
    public void submitDiagnosticsTest() throws Exception{
        final DiagnosticID value = getService().submitDiagnostics(new AsyncValue<DiagnosticID>()).get();
        Assert.assertNotNull(value);
